...
//for ($a=0;$a<=count($trackersData);$a++){
    ...
    //echo $url="http://mshastra.com/sendurl.aspx?user=20093058&pwd=Emsira$058&senderid=SIRAPROMO&mobileno=".$trackersData[$a]["phone"]."&msgtext=".$msg."&priority=High&CountryCode=971";
    $ch = curl_init($url);
